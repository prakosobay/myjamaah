            ...
            <div class="table-responsive">
                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody class="isi-table text-center">
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="deleteModal{{ $religion->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel{{ $religion->id }}" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-danger btn-sm mx-1 my-1" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $religion->id }}" data-id="{{ $religion->id }}">
                                    Delete
                                </button>
                            </td>
                        </tr>
